...
This project performs E2E tests on the [W3Schools](https://w3schools.com) website, generating a report of results. Tests are executed both in **Chrome** (desktop) and on an **Iphone 15** (mobile, emulated).
